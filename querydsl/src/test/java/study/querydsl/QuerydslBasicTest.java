...
public class QuerydslBasicTest {
    ...
    public void resultFetch() {
        ...
        results.getTotal();
        List<Member> cotent = results.getResults();
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = em.createQuery("select new study.querydsl.dto.MembetDto(m.username, m.age) from Member m", MemberDto.class)
                .getResultList();
    ...
    /**
     * 타입으로 넣으므로 생성자를 이용한 dto 생성의 경우 필드명이 달라도 상관없음.
     */
    @Test
